...
<div class="contenidor_2" style="float: right;">
	<div style="border: 1px solid #C0C000; padding-bottom: 20px;">
	  <p class="h1" style="background: black;">Monedero <span <?php echo $style.">** ".$moneder; ?> **</span></p>
	  
	  <table width="80%" align="center">
		<tr><td align="center" class='cos' style="text-transform: uppercase;">&Uacute;ltimos movimientos contabilizados</td></tr>
