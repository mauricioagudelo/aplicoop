...
//////////////////////////////////////////////////////////
$dbhost = 'xxxxxxxx'; //servidor on hi ha la base de dades
$dbuser = 'xxxxxxxx'; //nom de l'usuari de la base de dades
$dbpass = 'xxxxxxxx'; //password de la base de dades per l'usuari
$dbname = 'aplicoop_v3'; //nom de la base de dades

//$conn = mysql_connect($dbhost, $dbuser, $dbpass) or die ('Error connecting to mysql');
$conn = mysql_connect('xxxxxxxx', 'xxxxxxxx', 'xxxxxxxx') or die ('Error connecting to mysql');
mysql_query("SET NAMES 'utf8'"); //Suposo que s'ha de posar aquÃ­
//mysql_select_db($dbname);
mysql_select_db('aplicoop_v3');
...
$email_incidencies='XXXXXXXXXX@gmail.com';
...
$email_economia='XXXXXXXXXX@gmail.com';
