    ...
    <div class="pagina" style="margin-top: 10px;">
        ...
        <div class="contenidor_1" style="border: 1px solid green;">
            <p class='path'>
                ...
                >>><a href='totalcomanda.php?id=<?php echo $data . "&id2=" . $proces . "&id3=" . $grup . $link; ?>'>comanda
                    total <?php echo $title . " " . $proces . "-" . $grup . "-" . $data; ?></a>
            </p>
            <p class="h1" style="background: green; text-align: left; padding-left: 20px;">Comanda
                total <?php echo $title . " " . $proces . "-" . $grup . "-" . $data; ?></p>
	...
	ORDER BY pr.proveidora, pr.nom";
		...
		ORDER BY pr.nom";
            ...
            <p class="linia_button2"
               style="padding:4px 0px; height: 20px; background: green; text-align: center; vertical-align: middle;">
