...
<div class="contenidor_1" style="">
	...
	SOCIO/A <input name="from" type="text" id="txtUserInc">
	</p>
	<p class="form" style="text-align: center;">
	<span style="vertical-align: top;">incidencia </span>
	<textarea style="overflow: visible;" name="text" cols="60" rows="3" id="txtPassword"></textarea>
	</p>
	
	<div style="padding-top: 40px;">
		<p class="form" style="text-align: center;">
		<input name="btnIncidencies" type="submit" id="btnIncidencies" value="env&iacute;a" class="button">
		</p>
	</div>
</div>
...
<div class="contenidor_1" style="padding-top: 50px;">
	...
	env&iacute;a tu incidencia y en breve lo intentaremos solucionar
	</p>
</div>
</div>
</form>
